...
const commonProfileContent: Record<
  string,
  {
    headerSection:
    ...
    mainBody: Record<string, React.ReactNode>;
  }
> = {
...
const DisplayProfile = () => {
  // const { id } = useParams();
  // const { data: displayProfile, isError: mentorProfileError } = useGetMentorProfile(id ? id : "");

  // if ( displayProfile) {
  // return null;
  // }

  // const role = displayProfile.role as TRoles;
  const role = "mentor";
  return (
    <StyledDisplayProfileLayout>
      {commonProfileContent[role]?.headerSection &&
        commonProfileContent[role]?.mainBody && (
          <>
            <MentorProfileHeader
              userInfo={commonProfileContent[role].headerSection}
              role={role}
            />
            <MUITabs props={commonProfileContent[role].mainBody} />
          </>
        )}
    </StyledDisplayProfileLayout>
  );
